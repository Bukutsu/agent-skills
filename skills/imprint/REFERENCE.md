# Imprint pattern reference

Read this file when marking AI tells during an imprint rewrite or review. The patterns are reference, not a checklist to apply mechanically.
