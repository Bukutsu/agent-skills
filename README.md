...
npx skills add addyosmani/agent-skills -g --skill frontend-ui-engineering --skill source-driven-development -y
...
Check the install with `npx skills ls -g`. It should list 21 skills: 17 external and 4 local.
